 ...
 */
public class JViewerSwing implements CommandListener, ChangeListener, PropertyListener {
    protected JTopologySwing jtp;
     ...
     */
    public JViewerSwing(Topology topo) {
        this(topo, true);
    }
     ...
     */
    public JViewerSwing(Topology topo, boolean selfContained) {
        this(new JTopologySwing(topo), selfContained);
    }
     ...
     */
    public JViewerSwing(JTopologySwing jtopo) {
        this(jtopo, true);
    }
     ...
     *                 (e.g. for embedding the JViewer in your own frame).
     */
    public JViewerSwing(JTopologySwing jtopo, boolean windowed) {
        jtp = jtopo;
     ...
     */
    public JTopologySwing getJTopology() {
        return jtp;
    }
