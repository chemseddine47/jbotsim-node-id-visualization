...
public class JNode extends JButton implements MouseListener, MouseMotionListener, MouseWheelListener {
    ...
    public void paint(Graphics g) {
       ...
       //deduire la largeur et la longeur de scaledIcon 
       int width = scaledIcon.getWidth(null);
       int height = scaledIcon.getHeight(null);
       
      
        //dessiner et remplir le circle qui va remplacer l'icon de noeud**
        g2d.setColor(Color.BLACK);//couleur de cercle
        g2d.drawOval(0, 0, width, height);
        g2d.setColor(Color.lightGray);//couleur de l'arriere plan 
        g2d.fillOval(0, 0, width, height);
        
        //definir la police et la taille de text qu'on va afficher (ID de noued)
        g2d.setColor(Color.BLACK);
        g2d.setFont(new Font("Microsoft YaHei", Font.PLAIN,10));
        g2d.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
        //dessiner le text 
        g2d.drawString(Integer.toString(node.getID()),(int)(width-6)/2,(int)(height+8)/2);
