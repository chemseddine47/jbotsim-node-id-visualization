...
import jbotsimx.ui.JClock;
import jbotsimx.ui.JViewer;
import jbotsimx.ui.painting.*;


@SuppressWarnings("serial")
public class JTopologySwing extends JPanel implements ActionListener {
    ...
    protected JTopologySwing jtopo = this;
     ...
     */
    public JTopologySwing(Topology topo) {
        setTopology(topo);
    ...
    class EventHandler implements TopologyListener, MovementListener, ConnectivityListener,
        ...
        public void onNodeAdded(Node n) {
            JNodeSwing jv = new JNodeSwing(n);
        ...
        public void onNodeRemoved(Node n) {
            JNodeSwing jn = (JNodeSwing) n.getProperty("jnode");
            if (jn != null)
                remove(jn);
            updateUI();
        }
        ...
        public void onMove(Node n) {
            ...
            if (n.hasProperty("jnode"))
                ((JNodeSwing) n.getProperty("jnode")).update();
        }

        public void propertyChanged(_Properties o, String property) {
            if (o instanceof Node) { // Node
                JNodeSwing jn = (JNodeSwing) ((Node) o).getProperty("jnode");
